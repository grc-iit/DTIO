...
struct ArgPackRecur
{
  ...
  template <size_t i> constexpr decltype (auto) Forward () const
  {
    if constexpr (i == idx)
      {
...
template <size_t idx> struct ArgPackRecur<idx, EndTemplateRecurrence>
{
  /** Default constructor */
  ArgPackRecur () = default;
...
template <typename... Args> struct ArgPack
{
  ...
  template <size_t idx> constexpr decltype (auto) Forward () const
  {
...
private:
  ...
  constexpr static decltype (auto)
      _CallRecur (ArgPackT &&pack, F &&f, CurArgs &&...args)
  {
...
private:
  ...
  constexpr static decltype (auto)
      _MergePacksRecur (ArgPacksT &&packs, CurArgs &&...args)
  {
  ...
  template <size_t cur_pack, typename ArgPacksT, size_t i, typename ArgPackT,
            typename... CurArgs>
  constexpr static decltype (auto)
      _MergeRecur (ArgPacksT &&packs, ArgPackT &&pack, CurArgs &&...args)
  {
    if constexpr (i < ArgPackT::Size ())
      {
...
public:
  ...
  constexpr static decltype (auto)
      Product (ProductPackT &&prod_pack, ArgPacks &&...packs)
  {
...
private:
  ...
  template <size_t cur_pack, typename ProductPackT, typename OrigPacksT,
            typename... NewPacks>
  constexpr static decltype (auto)
      _ProductPacksRecur (ProductPackT &&prod_pack, OrigPacksT &&orig_packs,
                          NewPacks &&...packs)
  {
...
template <typename T, T Val> struct MakeConstexpr
{

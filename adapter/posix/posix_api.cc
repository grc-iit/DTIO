...
extern "C"
{
  ...
  int
  HERMES_DECL (MPI_Init_thread) (int *argc, char ***argv, int required,
                                 int *provided)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
   ...
   */
  int
  HERMES_DECL (open) (const char *path, int flags, ...)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
  ...
  int
  HERMES_DECL (open64) (const char *path, int flags, ...)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
  ...
  int
  HERMES_DECL (__open_2) (const char *path, int oflag)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  int
  HERMES_DECL (creat) (const char *path, mode_t mode)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__)
  ...
  int
  HERMES_DECL (creat64) (const char *path, mode_t mode)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__)
  ...
  ssize_t
  HERMES_DECL (read) (int fd, void *buf, size_t count)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  ssize_t
  HERMES_DECL (write) (int fd, const void *buf, size_t count)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  off_t
  HERMES_DECL (lseek) (int fd, off_t offset, int whence)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  off64_t
  HERMES_DECL (lseek64) (int fd, off64_t offset, int whence)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  int
  HERMES_DECL (__fxstat) (int __ver, int fd, struct stat *buf)
  {
    // int result = 0;
    // auto real_api = HERMES_POSIX_API;
  ...
  int
  HERMES_DECL (__fxstatat) (int __ver, int __fildes, const char *__filename,
                            struct stat *__stat_buf, int __flag)
  {
    ...
    if (real_api->check_path (__filename))
      {
        return dtio::posix::__fxstatat (__ver, __fildes, __filename,
                                        __stat_buf, __flag);
      }
    else if (ConfigManager::get_instance ()->NEVER_TRACE)
      {
        return real_api->__fxstatat (__ver, __fildes, __filename, __stat_buf,
                                     __flag);
      }
  ...
  int
  HERMES_DECL (__xstat) (int __ver, const char *__filename,
  ...
  int
  HERMES_DECL (__lxstat) (int __ver, const char *__filename,
                          struct stat *__stat_buf)
  {
    auto real_api = HERMES_POSIX_API;
  ...
  int
  HERMES_DECL (stat) (const char *pathname, struct stat *buf)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  int
  HERMES_DECL (__fxstat64) (int __ver, int fd, struct stat64 *buf)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  int
  HERMES_DECL (__fxstatat64) (int __ver, int __fildes, const char *__filename,
                              struct stat64 *__stat_buf, int __flag)
  {
    ...
    if (real_api->check_path (__filename))
      {
        return dtio::posix::__fxstatat64 (__ver, __fildes, __filename,
                                          __stat_buf, __flag);
      }
    else if (ConfigManager::get_instance ()->NEVER_TRACE)
      {
  ...
  int
  HERMES_DECL (__xstat64) (int __ver, const char *__filename,
  ...
  int
  HERMES_DECL (__lxstat64) (int __ver, const char *__filename,
                            struct stat64 *__stat_buf)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
  ...
  int
  HERMES_DECL (stat64) (const char *pathname, struct stat64 *buf)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  int
  HERMES_DECL (unlink) (const char *pathname)
  {
    DTIO_LOG_DEBUG_RANKLESS ("Intercepted " << __func__);
    auto real_api = HERMES_POSIX_API;
    std::string caller_name = "";
  ...
  // ssize_t HERMES_DECL(pread64)(int fd, void *buf, size_t count, off64_t
  // offset) {
